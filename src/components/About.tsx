  ...
  return <section className={cn('py-20 md:py-32 bg-white', 'text-orangery-900')}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <FadeIn delay={200}>
                <p className="text-lg md:text-l mb-6 font-medium">i like to think im a nice mixture of decent literacy, an illustratory imagination, and an uncompromising - almost spiteful - need to be good at everything i do.</p>
              </FadeIn>
              <FadeIn delay={300}>
